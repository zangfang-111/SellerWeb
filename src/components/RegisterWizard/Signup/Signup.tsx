...
import { WizardButton, WizardButtonType } from "../../shared/WizardButton";

const getClassNames = classNamesFunction<ISignupStyleProps, ISignupStyles>();

const SignupBase = ({ styles }: ISignupProps) => {
  ...
  return (
    <div className={classNames.root}>
      ...
      <div className="w-full py-6 px-10 flex flex-row justify-end">
        <WizardButton buttonType={WizardButtonType.Next} />
      </div>
    </div>
  );
};
